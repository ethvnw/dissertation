...
const moduleForm = document.getElementById('module_formset-0-container');
const buttonContainer = document.getElementById('button-container');
var numForms = document.getElementById('id_module_formset-TOTAL_FORMS');
...
addButton.onclick= (e) => {
    ...
    newForm.id = `module_formset-${formNum}-container`;
